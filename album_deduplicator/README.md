...
- סדר ההעדפה לשמירה נקבע כעת לפי סדר תיקיות הסריקה במסך ההגדרה: תיקייה עליונה עדיפה על זו שמתחתיה, גם כאשר ההשוואה היא בין תתי-תיקיות שלהן.
...
- כאשר מוגדר סדר העדפות, עותק שנמצא תחת root מוקדם יותר בסדר מקבל הכרעה אוטומטית לשמירה מול עותק תחת root נמוך יותר, גם כאשר איכות העותקים זהה או כאשר הנתיב נבחר בצורה שקולה אך לא מנורמלת.
