...
- מסך הסריקה מציג כעת אחוז התקדמות כולל ורציף ל-`100%` על פני כל תתי-השלבים (`setup`, `scan`, `quality`, `compare`), עם הבחנת צבע עדינה לפי השלב הפעיל במקום איפוס אחוזים בין משימות.
