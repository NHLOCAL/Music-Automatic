...
- מטאדאטה שמכילה ערכי placeholder כמו `Unknown Artist`, `Unknown Album`, `אמן לא ידוע` או `אלבום לא ידוע` מורידה כעת את ציון איכות האלבום.
- שמות קבצים שמורכבים רק ממספרי רצועות כמו `01.mp3`, `02.mp3` מזוהים כעת כשמות גנריים ומורידים את ציון האיכות.
...
- מסך הסקירה ורשימת הקבוצות מציגים כעת פירוט ציונים ונימוק `Gemini` בצורה נגישה דרך ריחוף או פוקוס על כפתורי מידע.
