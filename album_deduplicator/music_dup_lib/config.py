...
COMPARISON_RESULTS_CACHE_FILENAME = "comparison_results_cache.pkl" # שונה ל-pkl
...
MIN_SCORE_FOR_CACHING = 30.0 # קבוע חדש
...
GEMINI_MODEL_NAME = "gemini-2.5-flash-preview-05-20" # "gemini-2.5-flash-preview-05-20" # "gemini-2.0-flash-lite"
